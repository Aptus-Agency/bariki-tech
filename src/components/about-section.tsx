      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Experience Card */}
            <div className="hidden md:block absolute -bottom-6 right-4 sm:-right-6 bg-primary p-8 rounded-2xl shadow-xl z-10 flex flex-col items-center justify-center text-center min-w-[240px]">
