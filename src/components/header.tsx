                ...
                if (item.label === 'Services') {
                  return (
                    ...
                    >
                      <motion.div 
                        whileHover={{ scale: 1.05 }}
                        className={`relative group flex items-center gap-1.5 px-4 py-2.5 rounded-lg font-semibold text-base cursor-pointer transition-all duration-300 ${
                          isScrolled 
                      ...
                      <AnimatePresence>
                        {isServicesHovered && (
                          <motion.div
                            ...
                            className="absolute top-full left-1/2 -translate-x-1/2 mt-3 bg-white w-[750px] shadow-[0_20px_60px_rgba(0,0,0,0.15)] rounded-2xl overflow-hidden border border-gray-100"
                          >
                  ...
                  return (
                    ...
                    >
                      <Link 
                        href={item.href} 
                        className={`relative group flex items-center gap-1 px-4 py-2.5 rounded-lg font-semibold text-base transition-all duration-300 ${
                          isScrolled 
                            ? 'text-gray-700 hover:text-primary hover:bg-primary/5' 
                            : 'text-white hover:text-primary hover:bg-white/10'
                        }`}
